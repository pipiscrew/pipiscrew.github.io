---
title: Accessing files to network with different credential
author: PipisCrew
date: 2017-03-24
categories: [.net]
toc: true
...
firstly I tried this piece of code. If you accessing a network share if different credentials that the one is stored, you have to delete via the DOS command `net use * /delete`
```js
...
origin - http://www.pipiscrew.com/?p=6286 accessing-files-to-network-with-different-credential