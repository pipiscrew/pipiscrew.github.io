---
title: Show/hide all hidden settings in Windows7 Power Options
author: PipisCrew
date: 2018-01-28
categories: [news]
toc: true
...
this batch, enables more options on Control Panel > Power Options

<center>![alt](https://i.imgur.com/gDyktIt.png)</center>

save to a batch file the following & execute :
```js
REM src - https://gist.github.com/theultramage/cbdfdbb733d4a5b7d2669a6255b4b94b
@echo off
...
Display settings > user annoyance timeout = specify timeout threshhold within which the user would be considered annoyed.
Sleep > Allow wake timers = [enables or disables Windows to automatically wake your computer from sleep on a timer for scheduled tasks and other programs](http://www.fixedbyvonnie.com/2013/11/disable-delay-lock-screen-windows-8/) 
```

* * *

using [SIW](https://www.gtopala.com/) on Windows7, provides more options, as information you cant modify it.

Collapsed :
![alt](https://i.imgur.com/33wrK92.png)

Expanded with descriptions :
![alt](https://i.imgur.com/72aNuN0.png)

origin - http://www.pipiscrew.com/?p=12114 showhide-all-hidden-settings-in-windows7-power-options