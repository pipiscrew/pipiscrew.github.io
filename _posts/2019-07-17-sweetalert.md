---
title: SweetAlert2 with loading indicator
author: PipisCrew
date: 2019-07-17
categories: [angular]
toc: true
...
export class UsersApiService {
    ...
    get = (id: string) => this.http.get(User,`${this.apiEndPoint}/GetUserByID/${id}`);
    search = (body:any) => this.http.post(`${this.apiEndPoint}/GetUsers`, body);
